...
//     String? senderEmail = await authService.getCurrentUserEmail();
//
//     if (userId != null && senderEmail != null && _emailController.text.isNotEmpty) {
//       await firebaseData.sendFriendInvite(
//         senderId: userId,
//         recipientEmail: _emailController.text,
//         senderName: senderEmail, // Optional: can be replaced with display name
//       );
